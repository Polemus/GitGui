...
{
    [Theory]
    [InlineData("https://github.com/Polemus/GitGui.git")]
    [InlineData("https://github.com/Polemus/GitGui")]
    [InlineData("ssh://git@github.com/Polemus/GitGui.git")]
    [InlineData("git@github.com:Polemus/GitGui.git")]
    [InlineData("github.com:Polemus/GitGui.git")]
    public void EverySpellingOfTheSameRemoteAgrees(string url)
    {
        ...
        Assert.Equal("GitGui", identity.Name);
    ...
    {
        Assert.Equal("GitGui", HostResolver.Parse("https://example.com/o/GitGui.GIT")!.Name);
    }
    ...
    {
        Assert.Equal("GitGui", HostResolver.Parse("  https://github.com/Polemus/GitGui.git  ")!.Name);
    }
